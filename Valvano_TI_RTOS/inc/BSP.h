...
#define BUZZER  (*((volatile uint8_t *)(0x42000000+32*0x4C03+4*7)))
/* Port 2 Output, bit 7 is buzzer */
// ------------BSP_Buzzer_Init2------------
// Initialize the GPIO for P2.7, BoosterPack pin J4.40.
// To make sound you need to toggle P2.7.
// Input: none
// Output: none
void BSP_Buzzer_Init2(void);
#define BSP_Buzzer_Toggle() BUZZER^=0x01
