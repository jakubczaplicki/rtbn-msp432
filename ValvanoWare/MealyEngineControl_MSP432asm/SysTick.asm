...
;http://users.ece.utexas.edu/~valvano/
       ...
       .text
       .align  2
SYSTICK_STCSR   .field 0xE000E010,32  ; SysTick Control and Status Register
SYSTICK_STRVR   .field 0xE000E014,32  ; SysTick Reload Value Register
SYSTICK_STCVR   .field 0xE000E018,32  ; SysTick Current Value Register
N0x00FFFFFF     .field 0x00FFFFFF,32
       .global  SysTick_Init
       .global  SysTick_Wait
...
; Output: none
; Modifies: R0
DELAY10MS  .field 30000,32     ; clock cycles in 10 ms (assumes 3 MHz clock)
