...
P2DIR     .field 0x40004C05  ; Port 2 Direction
P2REN     .field 0x40004C07  ; Port 2 Resistor Enable
P2DS      .field 0x40004C09  ; Port 2 Drive Strength
P2SEL0    .field 0x40004C0B  ; Port 2 Select 0
P2SEL1    .field 0x40004C0D  ; Port 2 Select 1
P4DIR     .field 0x40004C25  ; Port 4 Direction
P4SEL0    .field 0x40004C2B  ; Port 4 Select 0
P4SEL1    .field 0x40004C2D  ; Port 4 Select 1
N499      .field 419,32      ; delay ~1.136 ms at 3 MHz
N2016     .field 2016,32     ; delay ~0.5 sec at 32,768 Hz
...
loop
    ...
    ; delay
;    LDR  R0, N419                   ; R0 = 419 (delay ~1.136 ms at 3 MHz)
;    LDR  R0, NSCALE                 ; R0 = 184543*SCALE (delay ~0.5 sec at 3 MHz; SCALE = 1)
    LDR  R0, N2016                  ; R0 = 2016 (delay ~0.5 sec at 32,768 Hz)
