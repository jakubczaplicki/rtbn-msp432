...
CSKEY       .field  0x40010400,32  ; Key Register
CSCTL0      .field  0x40010404,32  ; Control 0 Register
CSCTL1      .field  0x40010408,32  ; Control 1 Register
CSCTL2      .field  0x4001040C,32  ; Control 2 Register
CSIFG       .field  0x40010448,32  ; Interrupt Flag Register
CSCLRIFG    .field  0x40010450,32  ; Clear Interrupt Flag Register
PJSEL0      .field  0x40004D2A,32  ; Port J Select 0
PJSEL1      .field  0x40004D2C,32  ; Port J Select 1
PCMCTL0     .field  0x40010000,32  ; Control 0 Register
PCMCTL1     .field  0x40010004,32  ; Control 1 Register
PCMIFG      .field  0x4001000C,32  ; Interrupt Flag Register
PCMCLRIFG   .field  0x40010010,32  ; Clear Interrupt Flag Register
Key         .field  0x695A,32
N0x10000222 .field 0x10000222,32
N0x10000200 .field 0x10000200,32
N0x00000233 .field 0x00000233,32
N0x20100255 .field 0x20100255,32
N100000     .field  100000,32
N0xFFFF000F .field 0xFFFF000F,32
N0x695A0000 .field 0x695A0000,32
N500000     .field  500000,32
...
DCO12MHz  .EQU 0x00030000
      ...
      .global   Clock_Init32kHz
      .global   Clock_InitLowPower

;------------Clock_Init------------
; Configure for SMCLK = MCLK = (R0 parameter), ACLK = REF0CLK.
...
Clock_Init48MHz: .asmfunc
    ...
    LDR  R3, N100000                ; R3 is Prewait counter timeout value
    LDR  R1, PCMCTL1
...
clockInit48cont0
    ...
    LDR  R1, PCMCTL0
    LDR  R0, [R1]
    LDR  R2, N0xFFFF000F            ; PCMKEY bit field and AMR bit field
    BIC  R0, R0, R2                 ; clear PCMKEY bit field and AMR bit field
    LDR  R2, N0x695A0000            ; PCM key value
...
clockInit48cont1
    ...
    LDR  R3, N500000                ; R3 is CPMwait counter timeout value
    LDR  R1, PCMCTL0
...
clockInit48cont2
    ...
    LDR  R3, N100000                ; R3 is Postwait counter timeout value
    LDR  R1, PCMCTL1
...
clockInit48cont3
    ...
    LDR  R3, N100000                ; R3 is Crystalstable counter timeout value
