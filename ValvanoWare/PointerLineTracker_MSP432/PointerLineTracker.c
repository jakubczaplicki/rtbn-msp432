// PointerLineTracker.c
// Runs on MSP432
// Use a pointer implementation of a Moore finite state machine to make
...
/* This example accompanies the book
   ...
   Volume 2, Program 3.2, Example 3.1
...
int main(void){
  ...
  Pt = Center;                 // initial state: go straight
  while(1){
                               // set motors to current state's Out value
    MOTOR = (MOTOR&~0x03)|(Pt->Out);
