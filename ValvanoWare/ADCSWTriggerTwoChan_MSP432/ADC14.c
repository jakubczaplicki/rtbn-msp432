...
//end of debug code
  ...
  ADC14MCTL0 = 0x00000106;         // 6a) 0 to 2.5V, channel 6
  ...
  ADC14MCTL1 = 0x00000187;         // 6b) 0 to 2.5V, channel 7
  // 15   ADC14WINCTH Window comp threshold   0b = not used
  // 14   ADC14WINC   Comparator enable       0b = Comparator disabled
  // 13   ADC14DIF    Differential mode       0b = Single-ended mode enabled
  // 12   reserved                            0b (reserved)
  ...
  P4SEL1 |= 0xC0;                  // 8) analog mode on P4.7/A6 and P4.6/A7
  P4SEL0 |= 0xC0;
...
void ADC_In67(uint32_t *ch6, uint32_t *ch7){
  ...
  while((ADC14IFGR0&0x02) == 0){};  // 3) wait for ADC14IFG1
  *ch6 = ADC14MEM0;                 // 4) P4.7/A6 result 0 to 16383
  *ch7 = ADC14MEM1;                 //    P4.6/A7 result 0 to 16383
}
