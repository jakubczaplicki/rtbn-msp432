...
;export for use with debugger
        EXPORT num1 [DATA,SIZE=4]
        EXPORT num2 [DATA,SIZE=4]
        EXPORT num3 [DATA,SIZE=4]
        EXPORT num4 [DATA,SIZE=4]
        EXPORT num5 [DATA,SIZE=4]
