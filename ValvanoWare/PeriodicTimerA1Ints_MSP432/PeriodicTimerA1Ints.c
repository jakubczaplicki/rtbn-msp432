...
// the frequency of the Timer A1 interrupts.
...
// if desired interrupt frequency is f, TimerA1_Init parameter is (low-speed subsystem master clock (SMCLK))/f
...
//  TimerA0_Initb();  // Volume 2 example 6.7
//  while(1){
//    WaitForInterrupt();
//  }
//  TimerA1_Init(&UserTask, F20KHZ); // initialize Timer A1 (20,000 Hz)
  TimerA1_Init(&UserTask, F200HZ); // initialize Timer A1 (200 Hz)
